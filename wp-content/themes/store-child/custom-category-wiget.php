...
__('Custom Product Categories Widget', 'my_category_widget_domain'), 

// Widget description
array( 'description' => __( 'Home Page Widget - This widget displays your Product categories in a 3 or 4 column layout', 'my_category_widget_domain' ), ) 
);
}
						...
						<div class="content">
							...
							<?php if(isset($cat_title) && $cat_title == 'on') : ?>
								<a href="<?php echo $link; ?>">
  								<div class="layout-wrapper"><div class="centerblock">
    								<h4 class="centerinner post-title"><?php echo $cat->name; ?></h4>
    							</div></div>
  							</a>
	...
	<?php }
  	} // Class my_category_widget ends here

// Register and load the widget
function custom_category_load_widget() {
 register_widget( 'my_category_widget' );
}
add_action( 'widgets_init', 'custom_category_load_widget' );
