...
div.widget[id*=_obox_] .widget-top h3{
	color: #fff;
...
div.widget[id*=_obox_feature_] .widget-top h3{
	color: #fff;
	text-shadow: 1px 1px rgba(0,0,0,0.4);
...
div.widget[id*=_obox_hero_] .widget-top h3, div.widget[id*=_obox_blog_] .widget-top h3, div.widget[id*=_obox_page_] .widget-top h3, div.widget[id*=_obox_content_] .widget-top h3, div.widget[id*=_obox_category_widget] .widget-top h3, div.widget[id*=_obox_product_content_] .widget-top h3, div.widget[id*=_obox_features_widget] .widget-top h3, div.widget[id*=_obox_partners_] .widget-top h3{
	color: #fff;
	text-shadow: 1px 1px rgba(0,0,0,0.4);
...
.widget-liquid-right .widget .widget-top h3, .widget-liquid-right .postbox h3, .widget-liquid-right .stuffbox h3 {margin: 0px !important; border-bottom: none !important;}
 				...
 				<h2>Suggested Widget Setup</h2>
  				<div class="widget-panel">
					...
					<span class="suggested-widget white">(WordPress) Text</span>
  					...
  					<span class="suggested-widget orange">(Obox) Content Widget: Partners</span>
