...
class obox_page_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array('width' => 800, 'height' => 350, 'classname' => 'obox_page_widget', 'description' => 'Display image or title links to pages in a multi-column layout on your home page.' );
			parent::__construct( 'obox_page_widget', '(Obox) Page Widget', $widget_ops );
    }
	...
	<li class="page-widget widget clearfix">
		...
		<ul class="<?php echo $class; ?>-column  page-widget-item ">
			<?php for ($i = 1; $i <= $columns; $i++) { 
				...
				<?php endif; } ?>
					<div class="content">
						<?php if(isset($instance['show_images'.$i]) && isset($image) && $image != "") : ?>
