...
class obox_features_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array( 'classname' => 'obox_features_widget', 'description' => 'Display various kinds of content in a multi-column layout on your home page.' );
			parent::__construct( 'obox_features_widget', '(Obox) Features Widget', $widget_ops );
    }
