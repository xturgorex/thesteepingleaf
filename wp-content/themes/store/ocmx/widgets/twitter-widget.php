...
class obox_twitter_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array('classname' => 'obox-twitter-widget', 'description' => 'Display your latest Tweets.' );
			parent::__construct('obox_twitter_widget', '(Obox) Twitter Stream', $widget_ops);
    }
