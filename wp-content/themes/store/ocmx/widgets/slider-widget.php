<?php class obox_feature_posts_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array( 'classname' => 'obox_feature_posts_widget', 'description' => 'Display fading posts and images from a speficic category' );
			parent::__construct( 'obox_feature_posts_widget', '(Obox) Slider', $widget_ops );
    }
