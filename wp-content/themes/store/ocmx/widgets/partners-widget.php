...
class obox_partners_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array( 'classname' => 'obox_partners_widget', 'description' => 'Display your partners in a multi-column layout on your home page.' );
			parent::__construct( 'obox_partners_widget', '(Obox) Partners Widget', $widget_ops );
    }
