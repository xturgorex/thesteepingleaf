...
class obox_category_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array( 'classname' => 'obox_category_widget', 'description' => 'Home Page Widget - This widget displays your Product categories in a 3 or 4 column layout' );
			parent::__construct( 'obox_category_widget', '(Obox) Product Category Widget', $widget_ops );
    }
