...
class obox_small_ad_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array( 'classname' => 'adverts-125 column clearfix', 'description' => 'Display 125px linked images added under Theme Options > Adverts.' );
			parent::__construct( 'obox_small_ad_widget', '(Obox) 125 x 125 Adverts', $widget_ops );
    }
    ...
    function widget($args, $instance) {		
		...
		if(isset($instance["title"]))
			...
			<?php if(isset($title)) { echo $before_title; echo $title; echo $after_title; }
	...
	?>
        <p>
			<label for="<?php echo $this->get_field_id('title'); ?>">Title<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php if(isset($title)){ echo $title; } ?>" /></label>
           	...
           	<p><em>You can modify your sidebar ads in the <a href="admin.php?page=ocmx-adverts">OCMX Options</a> panel</em></p>
        <?php 
    }
