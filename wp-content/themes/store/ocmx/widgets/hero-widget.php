...
class obox_hero_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array('width' => 800, 'height' => 350, 'classname' => 'obox-hero-widget', 'description' => 'Display various kinds of content in a multi-column layout on your home page.' );
			parent::__construct( 'obox_hero_widget', '(Obox) Hero Widget', $widget_ops );
    }
			...
			<div class="middle-col">
				...
				<ul>
					...
					while ( $middle_posts->have_posts() ) : $middle_posts->the_post();
						global $post;
						$image_args  = array('postid' => $post->ID, 'width' => '190', 'height' => '190', 'hide_href' => false, 'exclude_video' => $post_thumb, 'wrap' => false, 'imglink' => false, 'resizer' => '1-1-medium');
