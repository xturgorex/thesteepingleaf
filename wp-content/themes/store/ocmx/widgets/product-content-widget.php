...
class obox_product_content_widget extends WP_Widget {
	...
	function __construct() {
			$widget_ops = array( 'classname' => 'obox_product_content_widget', 'description' => 'Display various kinds of content in a multi-column layout on your home page.' );
			parent::__construct( 'obox_product_content_widget', '(Obox) Product Content Widget', $widget_ops );
    }
